...
export function InteractiveHierarchy() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-indigo-900 mb-4">Example: Preparedness App Home Screen</h3>
        <Card className="overflow-hidden">
          <div className="bg-white p-6">
            ...
            <div className={`mb-6 ${showHierarchy ? 'ring-2 ring-blue-400 ring-offset-2' : ''}`}>
              ...
              >
                Welcome back, Sierra — Your Prep Status
              </h1>
              <p className="text-gray-600">
                3 actions pending • Kit at 80% • Family plan reviewed 2 wks ago
              </p>
            </div>
            ...
            <div className={`bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl p-6 mb-6 ${showHierarchy ? 'ring-2 ring-green-400 ring-offset-2' : ''}`}>
              <Badge className="bg-yellow-400 text-gray-900 mb-2">ALERT</Badge>
              <h3 className="text-white mb-2">
                Severe Weather Warning — Tonight
              </h3>
              <p className="text-indigo-100 mb-4">
                Secure outdoor items, prepare go‑bag, avoid non‑essential travel
              </p>
              ...
              <div className="mt-6 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-700">Primary: Status summary / critical info</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-green-400 rounded"></div>
                    <span className="text-gray-700">Secondary: Active alert / next action</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-orange-400 rounded"></div>
                    <span className="text-gray-700">Tertiary: Supporting shortcuts</span>
                  </div>
                  <div className="flex items-center gap-2">
